...
// MainRVIA.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMainRVIAApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMainRVIAApp

CMainRVIAApp::CMainRVIAApp()
{
...
// Único objeto CMainRVIAApp

CMainRVIAApp theApp;


// Inicialización de CMainRVIAApp

BOOL CMainRVIAApp::InitInstance()
{
